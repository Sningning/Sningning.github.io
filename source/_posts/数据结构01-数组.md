...
<div align="center"><img width="" src="https://cdn.jsdelivr.net/gh/Sningning/BlogPictures/1-Array/resize1.gif"></img></div>
<br/>
<div align="center"><img width="" src="https://cdn.jsdelivr.net/gh/Sningning/BlogPictures/1-Array/resize2.gif"></img></div>
...
<div align="center"><img width="" src="https://cdn.jsdelivr.net/gh/Sningning/BlogPictures/1-Array/complexity.gif"></img></div>
<br/> 
...
```
<div align="center"><img width="" src="https://cdn.jsdelivr.net/gh/Sningning/BlogPictures/1-Array/LazyResize.gif"></img></div>

---

# 9. 数组类的整体实现

为了方便打印输出，覆盖了 `toString()` 方法。整体实现：[Array.java](https://github.com/Sningning/DataStructures/tree/master/01-Arrays)
